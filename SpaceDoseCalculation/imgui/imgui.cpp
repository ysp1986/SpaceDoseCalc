...
/*
 ...
 A: In your Render function, try translating your projection matrix by (0.5f,0.5f) or (0.375f,0.375f).
    Also make sure your orthographic projection matrix and io.DisplaySize matches your actual FrameTextureBuffer dimension.
...
ImGuiIO::ImGuiIO()
{
    ...
    FontDefault = NULL;
    DisplayFrameTextureBufferScale = ImVec2(1.0f, 1.0f);
    MousePos = ImVec2(-1,-1);
